...
| Finite positive order-characters compose by concatenation. | **Secured by construction.** | Concatenation gives associative addition and forgets the join; summands require no tags. The empty order-character remains Open. | **Registered** as positive natural counting for this additive finite-chain core; further natural-number surplus is quarantined. |
