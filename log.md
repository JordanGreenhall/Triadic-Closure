...
## [2026-06-21] create | Initial execution wiki
- Created Obsidian-compatible wiki at `/Users/roberthall/Desktop/physics-execution-wiki`.
- Copied raw package and context ledger into `raw/`.
- Wrote schema, index, corpus lineage, supersession map, agent execution rules, known failure modes, Jordan decisions, and initial curated concept/result pages.
...
- Added `viewing-this-wiki.md` and `_meta/build_html_wiki.py` for Obsidian/static HTML browsing.
