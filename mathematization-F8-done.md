...
- **[selection] The elementary couplings.** For this construction, select a vertex P with finitely many admissible elementary next-couplings, one per chosen neighbor/aspect at depth + 1. M1 representational atomicity does not imply finite degree. Label the selected couplings $e_1, \dots, e_n$; they are the basis directions of this finite configuration-space model.
