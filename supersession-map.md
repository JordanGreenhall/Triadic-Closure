...
- Current: [P23 Stress-Energy as a Three-Office Source](p23-stress-energy-as-three-office-source.md) Secures the conditional second-moment symmetry, observer-relative `rho/q/S` decomposition, bounded office alignment, and one exact selected two-stream population example. Native source vectors/weights, general stress span, coefficient meaning, and covariant conservation remain Open/Conjectured.
