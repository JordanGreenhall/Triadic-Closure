...
### 2.3 Proton/neutron identity and candidate metastability

P14 and P20 supply:

- **candidate metastable standing:** the neutron `udd` mark-configuration on the common color-singlet baryon closure;
...
- one proton/neutron identity distinction on a shared closure; empirical neutron decay may orient later work.
...
The modeled baryon supplies scoped perturbative stability. The electron bare repeat supplies persistence but not, merely by recurrence, a perturbative stability theorem. P20 supplies only a Conjectured comparative attractor/metastability structure at the mark-configuration scope.
...
Established: baryon scoped persistence/stability; electron scoped persistence/native ruler; proton/neutron shared-closure identity distinction.
