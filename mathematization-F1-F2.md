...
- **(M4) Orientation-sourced discrete grading.** [forced-prior, 0.7] The integers at admissibility grade: ordinal counting by oriented succession (role-distinct positions in oriented chains). This is the corpus’s exhibited construction of count. Symmetry alone supplies no labels or ordered roles; unordered cardinality for symmetric multiplicity remains Open.
