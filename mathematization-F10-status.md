...
- **F11/P24** (the Einstein form via Lovelock): the named rigidity implication is conditional mathematics, but the framework equation is not obtained merely by resolving F10 and its sign. P24 additionally requires an exact locality/order theorem, complete tensor/covariance premises, a conserved physical source, nonzero source coupling, and tensor/nonlinear completion.
