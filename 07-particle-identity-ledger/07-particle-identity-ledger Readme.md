---
title: "Frontier Item 7: Particle-identity ledger"
type: process
...
Record the canonical adjudication ledger separating native particle roles from unearned SM property bundles.
...
FAIL if admitting an empirical particle label imports its full SM bundle as framework-native.

## Integration rule

Dependent pages may use the Registered native roles only to the degree specified by the ledger rows. Particle names may not carry their full Standard Model bundles.
