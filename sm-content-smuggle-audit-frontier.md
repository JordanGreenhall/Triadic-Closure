...
**Cleanup work:** use [P23 Stress-Energy](p23-stress-energy-as-three-office-source.md) for source claims, [P24 Conditional Tensor Rigidity](p24-full-einstein-form-as-conditional-rigidity.md) for the full-field boundary, and [P25 GR/QM Background Conflict](p25-grqm-background-conflict-and-nonrenormalizability.md) for G2/G3. P24's promotable gate is a formal locality-to-order theorem with scaling and correction control. P25 separately requires one explicit phase implementation and one selected perturbative comparison target before its diagnosis can be strengthened.
