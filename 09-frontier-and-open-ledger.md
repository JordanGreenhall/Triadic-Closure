---
title: "Frontier and Open Ledger"
wiki-doc: 09
...
- floor-level sorter of self-relation and other-relation — **Open**;
- disjunctive compound bases and topology-like closure at the floor — **Open**;
- arbitrary compound-address injectivity — **Open**;
- unordered cardinality of symmetric multiplicities — **Open**;
- standing of the empty order-character — **Open**;
...
- smooth-manifold and rotational-invariance seal in the spatial sector — **Registered, not Sealed**, through the named universality import;
- exact local Lorentz — **Defended posit** at the exactness ceiling; not an owed proof task;
- exclusion of the cubic anisotropic rival — **Registered-candidate**;
- confinement-energy law — **Open**;
- mature Hamiltonian terms and spectrum — **Open / values-side**;
- absolute stability rates and barriers — **Open / values-side**.

**Traveling condition:** G1 governs spatial manifold/order recovery only. It does not condition the internal carrier, Born weighting, closure measure, or mass relation.
...
- center-lock — **Open**;
- exact charge values — **values-side**;
- electroweak mixing and symmetry breaking — **Open / quarantined from native use**;
...
The identity \(\Lambda=3\Omega_\Lambda R_H^{-2}\) is definitional and supplies no independent confirmation. The transitive/reflexive reading of \((\Omega_m,\Omega_\Lambda)\) is interpretation only.

## 6. Chemistry and the physics–chemistry boundary
...
- compensated-concerted synchronization residue — **Conjectured-strong**;
- exponential rate form — **Conjectured-strong**;
- prefactors, absolute rates, barriers, and equilibrium constants — **Open / values-side**;
...
## 7. Cross-domain handoff

The general handoff mechanism is **Registered-candidate** from one fully exhibited instance. A chemistry-to-biology continuation is not licensed until the relevant chemistry frontier is constructed on registered parents.
...
| dimension-two frame gap | preserve the caveat in every two-dimensional Born application |
| decoherence-floor Lead | do not spend as Registered before the which-path substrate check |
| sigma/pi | do not promote beyond Conjectured-strong |
| Madelung | do not present exact \(n+l\) ordering as Registered |
| Lambda present value | do not report the FRW identity as an independent prediction |
| exact-local-Lorentz ceiling | do not manufacture a further proof task |

## 9. Global quarantines

The following may be used only as explicit external comparison unless separately reconstructed:

- quantitative QCD running, lattice results, flux tubes, and empirical binding decompositions;
- photon/W/Z particulars, electroweak mixing and breaking, Higgs potential and mass, Yukawa couplings, and the observed generation spectrum;
- anomaly cancellation as a native framework constraint;
- radiation and photon-as-entity, including photochemistry;
- FRW/Friedmann or holographic-dark-energy machinery as a derivation of Lambda dynamics;
- kilogram/electron-volt absolute calibration;
- empirical coefficients, rates, prefactors, barriers, equilibrium constants, and other values explicitly marked values-side.

A quarantined result may orient comparison. It may not supply warrant to a framework claim.
