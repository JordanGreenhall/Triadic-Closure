...
| Single-time Lorentzian / pseudo-Riemannian signature | Φ §7.3; `dimension-and-spacetime-status.md`; `lorentz-from-recoupling.md`; `physics-walk-D1-D5-consolidated.md` | Yes, if locked | P4: Registered, not sealed, for the `1|3` orientation germ. P5: later Registered–Sealed result for the sign-valued interval/flat Lorentz symmetry within its declared conditions. | Keep the P4 germ separate from P5 propagation, null structure, and the named external theorem. Neither supplies P7 manifold recovery. |
