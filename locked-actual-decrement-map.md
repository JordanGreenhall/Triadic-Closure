...
| Single-time Lorentzian / pseudo-Riemannian signature | Φ §7.3; `lorentz-from-recoupling.md`; `physics-walk-D1-D5-consolidated.md` | Yes, if locked | Registered and Sealed for the signature/flat Lorentz structure | Current support comes from Lorentz/re-coupling and D1-D5 consolidated material, not Φ's lock. |
