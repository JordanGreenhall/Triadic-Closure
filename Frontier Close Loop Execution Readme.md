...
# Frontier Closed-Loop Execution Index

This folder is the worker-facing execution layer for the SM frontier.
...
- [SM content smuggle audit frontier](sm-content-smuggle-audit-frontier.md)
- [Items 2–4 integrated status](../process/sm-frontier-loop-state/02-04-items-2-3-4-status.md)
- [Item 5 status](../process/sm-frontier-loop-state/05-gauge-architecture-beyond-color.md)
- [Item 6 status](../process/sm-frontier-loop-state/06-spin-helicity-chirality-lift.md)
- [Item 7 status](../process/sm-frontier-loop-state/07-particle-identity-ledger.md)
- [Item 8 status](../process/sm-frontier-loop-state/08-charge-hypercharge-ledger.md)
- [Item 9 status](../process/sm-frontier-loop-state/09-specific-color-dynamics-qcd-quarantine.md)
- [Item 11 status](../process/sm-frontier-loop-state/11-decay-product-registration.md)
- [Item 12 status](../process/sm-frontier-loop-state/12-gravity-full-gr-imports.md)
- [Items 3-10 concept-load/pass ledger](../process/sm-frontier-loop-state/03-10-physics-concept-load-pass-ledger.md)
- [Claim status vocabulary](../concepts/claim-status-vocabulary.md)
- [Triadic Structure of Relating — canonical raw package](../raw/package/triadic-structure-of-relating-rev-canonical.md)
- [Entering a New Domain](../raw/package/entering-a-new-domain.md)
- [Architectonic Rigor](../raw/package/architectonic-rigor-complete.md)
...
- [Item 2: Amplitude/readout theorem](02-amplitude-readout-theorem/02-amplitude-readout-theorem Readme.md) — PASS for measured downstream load; frequency=weight demand Dissolved; dim-2 caveat travels
...
- [Item 5: Gauge architecture beyond color: SU(2), U(1), completeness](05-gauge-architecture-beyond-color/05-gauge-architecture-beyond-color Readme.md) — split: SU(2)/U(1) Registered source-load PASS; completeness defended posit; EW residuals quarantined
- [Item 6: Spin / helicity / chirality / lift theorem](06-spin-helicity-chirality-lift/06-spin-helicity-chirality-lift Readme.md) — PASS for registered spin/helicity/chirality machinery; exact module remains Open
