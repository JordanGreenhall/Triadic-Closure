...
25. Full gravity beyond weak-field.
26. Matter spectrum and generations.

## Bottom line

P22 Registers a bounded static participation-curvature construction without turning its selected source/clock map, retained numerical reports, separate dimensional checks, or conditional Poisson form into a sealed `3+1` gravity derivation. P23 Secures conditional second-moment and decomposition mathematics and one selected spatial-stress population example. Sector names are Registered for an independently licensed source; the exact This/From/With correspondence is Conjectured/Unregistered, and native source weights, general stress dynamics, and conservation remain open. P22's scalar normalization and `G` remain Open; P24 remains the unopened full-field-equation neighbor.

See also: [P23 Stress-Energy as a Three-Office Source](p23-stress-energy-as-three-office-source.md), [P22 Weak-Field Gravity as Participation Curvature](p22-weak-field-gravity-as-participation-curvature.md), and [P21 With-to-This Closure and Decay](with-to-this-closure.md).
