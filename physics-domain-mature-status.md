...
22. **P23-F1 — native source vectors, weights, and coefficient semantics:** a real weighted second moment is symmetric and admits the bounded source reading once vectors and weights are supplied. Missing: a native map from conditioning events to tangent vectors and real weights, positivity/normalization, units, and exclusion or grading of alternative source constructions. False-completion warning: the word `amplitude` or an edge count must not become a real physical stress-energy weight by naming. Local owner: `p23-stress-energy-as-three-office-source.md`. Next research action: construct the source-vector and real-weight map before coupling to P22 or P24.
23. **P23-F2 — local balance law and covariant conservation:** the exact divergence identity exhibits continuity and vector-transport terms, and constant-vector independently conserved streams are a conditional example. Missing: a native local evolution law, momentum/transport equation, inter-stream exchange accounting, covariantization, and proof of total cancellation. False-completion warning: scalar continuity or generic conservation language does not prove `nabla_mu T^{mu nu}=0`. Local owner: `p23-stress-energy-as-three-office-source.md`. Next research action: exhibit the local source evolution and prove the full tensor balance.
24. **P23-F3 — general spatial-stress population and office correspondence:** one selected two-stream construction produces nonzero spatial stress, including a zero-net-flux case, and the full spatial sector is mathematically available. Missing: a general isotropic/anisotropic construction, framework-meaningful coefficients, and a derivation or rejection of the office table consistent with P4's From/With index blocks and P17's This–From energy relation. False-completion warning: one nonzero `T^{nn}` is not arbitrary material stress-energy or a With-office theorem. Local owner: `p23-stress-energy-as-three-office-source.md`. Next research action: determine the realized spatial-second-moment span and adjudicate the office proposal against its dependencies.
