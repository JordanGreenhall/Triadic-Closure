...
| P5 Lorentzian interval / metric symmetry | Registered and Sealed, with external theorem note | P5 commensurates P4's temporal/spatial partition through propagation and the invariant link/step identity; the Lorentz proof preserves null structure and uses Alexandrov-Zeeman as a named external implication. | This later result must not be back-spent as P4's dimensional warrant. Framework supplies the causal hypotheses; the external theorem supplies null-cone-preserving => Lorentz. |
