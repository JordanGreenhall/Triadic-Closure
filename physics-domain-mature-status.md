...
22. Full gravity beyond weak-field.
23. Matter spectrum and generations.

## Bottom line

P21 Registers the displayed forward With-to-This closure and the generic structural decay classifier without upgrading its inverse, products, or rates. P22 Registers a bounded static participation-curvature construction without turning its selected source/clock map, retained numerical reports, separate dimensional checks, or conditional Poisson form into a sealed `3+1` gravity derivation. Source/clock uniqueness, common continuum implementation, source normalization, and `G` remain in P22's synchronized frontiers; P23/P24 remain unopened neighbors.

See also: [P22 Weak-Field Gravity as Participation Curvature](p22-weak-field-gravity-as-participation-curvature.md), [P21 With-to-This Closure and Decay](with-to-this-closure.md), and [P20 Baryon Closure and Proton–Neutron Relation](p20-baryon-closure-and-proton-neutron-relation.md).
