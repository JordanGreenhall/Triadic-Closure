...
| P23 stress-energy source and three-office split | **Conditional mathematics Secured; bounded representation Registered** | Weighted second moment is symmetric; observer split gives energy/flux/spatial stress; selected two-stream example populates With stress. Native weights, general stress span, and conservation remain Open/Conjectured. |
