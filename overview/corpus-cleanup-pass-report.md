...
4. **Earlier second-order full-Einstein correction, now superseded.** This cleanup pass recorded the G1-conditioned one-step route as Registered conditional. [P24](../p24-full-einstein-form-as-conditional-rigidity.md) now governs: bounded one-step locality does not prove exact continuum derivative order; the general named Lovelock-style theorem family is accepted externally at conditional scope, while the exact P24 schema and claim-specific applicability remain Conjectured/Open and Unregistered.
