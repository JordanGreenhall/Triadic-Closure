...
4. **Earlier second-order full-Einstein correction, now superseded.** This cleanup pass recorded the G1-conditioned one-step route as Registered conditional. [P24](../p24-full-einstein-form-as-conditional-rigidity.md) now governs: one-step locality does not prove exact continuum derivative order, the framework premise map remains Conjectured/Unregistered, and only the admitted Lovelock-style implication is Secured conditionally as mathematics.
